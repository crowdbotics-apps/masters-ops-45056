"""
Django settings for masters_ops_45056 project.
...
ROOT_URLCONF = 'masters_ops_45056.urls'
...
WSGI_APPLICATION = 'masters_ops_45056.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "masters_ops_45056 API",
    "DESCRIPTION": "API documentation for masters_ops_45056 App",
    "VERSION": "v1",
}
